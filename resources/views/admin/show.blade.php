        ...
        <x-content>
                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des text-soft">
                                            <p>Welcome to E-Vote Dashboard.</p>
                                        </div>
                            ...
                            <div class="nk-block">
                                <div class="row g-gs">
                                    ...
                                    <div class="col-md-3">
                                        <div class="card card-bordered card-full">
                                            <div class="card-inner">
                                                <div class="mb-0 card-title-group align-start">
                                                    <div class="card-title">
                                                        <h6 class="subtitle">Total Voters</h6>
                                                    </div>
                                                    <div class="card-tools">
                                                        <em class="card-hint icon ni ni-help-fill" data-toggle="tooltip"
                                                            data-placement="left" title=""
                                                            data-original-title="Total Deposited"></em>
                                                    </div>
                                                </div>
                                                <div class="card-amount">
                                                    <span class="amount"> 9,595 <span
                                                            class="currency currency-usd"></span>
                                                    </span>
                                    ...
                                    <div class="col-md-9 col-xxl-4">
                                        <div class="card card-bordered card-full">
                                            <div class="card-inner d-flex flex-column h-100">
                                                <div class="mb-3 card-title-group">
                                                    <div class="card-title">
                                                        <h6 class="title">Top Votes</h6>
                                                        <p>Top votes</p>
                                                    </div>
                                                    <div class="card-tools mt-n4 mr-n1">
                                                        <div class="drodown">
                                                            ...
                                                            <div
                                                                ...
                                                                <ul class="link-list-opt no-bdr">
                                                                    <li><a href="#"><span>Sort Asc</span></a></li>
                                                                    <li><a href="#" class="active"><span>Sort
                                                                                Desc</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="progress-list gy-3">
                                                    <div class="progress-wrap">
                                                        <div class="progress-text">
                                                            <div class="progress-label">Keith Jensen</div>
                                                            <div class="progress-amount">5880</div>
                                                        </div>
                                                    ...
                                                    <div class="progress-wrap">
                                                        <div class="progress-text">
                                                            <div class="progress-label">Daisy Morgan</div>
                                                            <div class="progress-amount">2104</div>
                                                        </div>
                                                        <div class="progress progress-md">
                                                    ...
                                                    <div class="progress-wrap">
                                                        <div class="progress-text">
                                                            <div class="progress-label">Keisha Clarke</div>
                                                            <div class="progress-amount">1689</div>
                                                        </div>
                                                        <div class="progress progress-md">
                                                ...
                                                <div class="mt-auto invest-top-ck">
                                                    ...
                                                    <canvas class="iv-plan-purchase chartjs-render-monitor"
                                                        id="planPurchase" width="424" height="50"
                                                        style="display: block; width: 424px; height: 50px;"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- .col -->
                                        ...
                                        <div class="card card-bordered h-100">
                                            <div class="card-inner">
                                                ...
                                                <div class="form-group">
                                                    <label class="form-label" for="full-name">Election URL</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="full-name"
                                                            value="https://evote.fdght.com/election/hIexm">
                                                    </div>
                                                    <a href="#" class="mt-2 btn btn-primary">Copy Election URL</a>
                                                </div>

                                                <div class="form-group">
                                                    <label class="form-label" for="full-name">Preview URL (Test)</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="full-name"
                                                            value="https://evote.preview.com/election/hIexm">
                                                    </div>
                                                    <a href="#" class="mt-2 btn btn-primary">Copy Preview URL</a>
                                                </div>
                                        ...
                                        <div class="card card-bordered h-100">
                                                    ...
                                                    <div class="card-tools">
                                                        <div class="drodown">
                                                            <a href="#"
                                                                ...
                                                                data-toggle="dropdown">30 Days</a>
                                                            <div
                                            ...
                                            <div class="nk-tb-list is-loose traffic-channel-table">
                                                <div class="nk-tb-item nk-tb-head">
                                                    ...
                                                    <div class="text-right nk-tb-col nk-tb-trend tb-col-sm">
                                                        <span>Trend</span></div>
                                                </div><!-- .nk-tb-head -->
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="text-right nk-tb-col nk-tb-trend">
                                                        <div class="ml-auto traffic-channel-ck">
                                                            <div class="chartjs-size-monitor">
                                                                <div class="chartjs-size-monitor-expand">
                                                                    <div class=""></div>
                                                                </div>
                                                            ...
                                                            <canvas class="analytics-line-small chartjs-render-monitor"
                                                                id="OrganicSearchData" width="130" height="44"
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="text-right nk-tb-col nk-tb-trend">
                                                        <div class="ml-auto traffic-channel-ck">
                                                            ...
                                                            <canvas class="analytics-line-small chartjs-render-monitor"
                                                                id="SocialMediaData" width="130" height="44"
                                                                style="display: block; width: 130px; height: 44px;"></canvas>
                                                        </div>
                                                    </div>
                                                </div><!-- .nk-tb-item -->
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="text-right nk-tb-col nk-tb-trend">
                                                        <div class="ml-auto traffic-channel-ck">
                                                            ...
                                                            <canvas class="analytics-line-small chartjs-render-monitor"
                                                                id="ReferralsData" width="130" height="44"
                                                                style="display: block; width: 130px; height: 44px;"></canvas>
                                                        </div>
                                                    </div>
                                                </div><!-- .nk-tb-item -->
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="text-right nk-tb-col nk-tb-trend">
                                                        <div class="ml-auto traffic-channel-ck">
                                                            ...
                                                            <canvas class="analytics-line-small chartjs-render-monitor"
                                                                id="OthersData" width="130" height="44"
                                                                style="display: block; width: 130px; height: 44px;"></canvas>
                                                        </div>
                                                    </div>
                                                </div><!-- .nk-tb-item -->
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        <div class="card card-bordered h-100">
                                            <div class="card-inner h-100 stretch flex-column">
                                                ...
                                                <div class="my-auto device-status">
                                                    <div class="device-status-ck">
                                                        ...
                                                        <canvas class="analytics-doughnut chartjs-render-monitor"
                                                            id="deviceStatusData"
                                                            style="display: block; width: 257px; height: 200px;"
                                                            width="257" height="200"></canvas>
                                                    </div>
                                                    <div class="device-status-group">
                                                        <div class="device-status-data">
                                                            ...
                                                            <div class="change up text-danger"><em
                                                                    class="icon ni ni-arrow-long-up"></em>4.5%</div>
                                                        </div>
                                                        <div class="device-status-data">
                                                            <em data-color="#baaeff" class="icon ni ni-mobile"
                                                                style="color: rgb(186, 174, 255);"></em>
                                                            <div class="title">Mobile</div>
                                                            <div class="amount">14.2%</div>
                                                            <div class="change up text-danger"><em
                                                                    class="icon ni ni-arrow-long-up"></em>133.2%</div>
                                                        </div>
                                                        <div class="device-status-data">
                                                            ...
                                                            <div class="change up text-danger"><em
                                                                    class="icon ni ni-arrow-long-up"></em>25.3%</div>
                                                        </div>
                                        ...
                                        <div class="card card-bordered h-100">
                                            <div class="card-inner">
                                                ...
                                                <div class="analytics-map">
                                                    <div class="vector-map" id="worldMap"
                                                        style="position: relative; overflow: hidden; background-color: transparent;">
                                                        <svg width="256.656" height="160">
                                                            <g
                                                                transform="scale(0.2701642105263158) translate(0, 21.116202231781045)">
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#c8d3e3" original="#c8d3e3"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#c6d2e4" original="#c6d2e4"
                                                                    id="jqvmap1_mx" class="jqvmap-region"
                                                                    fill-opacity="1"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cbd6e2" original="#cbd6e2"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cbd7e2" original="#cbd7e2"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cad5e3" original="#cad5e3"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#c5d1e4" original="#c5d1e4"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#abb9ed" original="#abb9ed"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#adbbed" original="#adbbed"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#c4cfe5" original="#c4cfe5"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#798bff" original="#798bff"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#c4d0e5" original="#c4d0e5"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_cv" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_ht" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_fk" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_is" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cad5e3" original="#cad5e3"
                                                                    id="jqvmap1_no" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_lk" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_cu" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_ec" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#c3cfe5" original="#c3cfe5"
                                                                    id="jqvmap1_ca" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_gt" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cad6e3" original="#cad6e3"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cad6e3" original="#cad6e3"
                                                                    id="jqvmap1_ve" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_gy" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cbd6e2" original="#cbd6e2"
                                                                    id="jqvmap1_pe" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_bo" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cbd6e2" original="#cbd6e2"
                                                                    id="jqvmap1_cl" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_kp" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#c6d2e4" original="#c6d2e4"
                                                                    id="jqvmap1_kr" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cbd6e2" original="#cbd6e2"
                                                                    id="jqvmap1_kz" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_tm" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_uz" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_tj" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_kg" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_af" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cbd6e2" original="#cbd6e2"
                                                                    id="jqvmap1_pk" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_np" class="jqvmap-region"></path>
                                                                <path
                                                                    d="M695.4,248.08l1.55,2.12l5.24,0.04l-0.53-2.9L695.4,248.08L695.4,248.08z"
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_bt" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cad5e3" original="#cad5e3"
                                                                    id="jqvmap1_th" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_kh" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_la" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cad5e3" original="#cad5e3"
                                                                    id="jqvmap1_ir" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#c8d3e3" original="#c8d3e3"
                                                                    id="jqvmap1_tr" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cad5e3" original="#cad5e3"
                                                                    id="jqvmap1_sa" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_sy" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_iq" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#bfcbe6" original="#bfcbe6"
                                                                    id="jqvmap1_gb" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cbd6e2" original="#cbd6e2"
                                                                    id="jqvmap1_ie" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#c9d5e3" original="#c9d5e3"
                                                                    id="jqvmap1_se" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_lt" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cad5e3" original="#cad5e3"
                                                                    id="jqvmap1_pl" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#c0cce6" original="#c0cce6"
                                                                    id="jqvmap1_it" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#bdcae7" original="#bdcae7"
                                                                    id="jqvmap1_fr" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#c8d3e4" original="#c8d3e4"
                                                                    id="jqvmap1_nl" class="jqvmap-region"></path>
                                                                <path
                                                                    d="M461.61,176.52l-0.64,1.6l6.88,4.54l1.98,0.47l0.07-2.15l-1.73-1.94h-1.06l-1.45-1.65L461.61,176.52L461.61,176.52z"
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#c9d5e3" original="#c9d5e3"
                                                                    id="jqvmap1_be" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#b9c6e9" original="#b9c6e9"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cad5e3" original="#cad5e3"
                                                                    id="jqvmap1_dk" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#c9d4e3" original="#c9d4e3"
                                                                    id="jqvmap1_ch" class="jqvmap-region"></path>
                                                                <path
                                                                    d="M488.43,184.87h2.97h1.46l2.37,1.69l4.39-3.65l-4.26-3.04l-4.22-2.04l-2.89,0.52l-3.92,2.52L488.43,184.87L488.43,184.87z"
                                                                    stroke="#dee6ed" stroke-width="1"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cbd6e2" original="#cbd6e2"
                                                                    id="jqvmap1_cz" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_sk" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cad5e3" original="#cad5e3"
                                                                    id="jqvmap1_at" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cbd6e2" original="#cbd6e2"
                                                                    id="jqvmap1_ro" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_rs" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_bg" class="jqvmap-region"></path>
                                                                <path
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#ccd7e2" original="#ccd7e2"
                                                                    id="jqvmap1_mk" class="jqvmap-region"></path>
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-opacity="1" fill="#cad5e3" original="#cad5e3"
                                                                    id="jqvmap1_gr" class="jqvmap-region"></path>
                                                            </g>
                                                        </svg></div>
                                            ...
                                            <div class="card-inner">
                                                ...
                                                <div class="traffic-channel">
                                                    <div class="traffic-channel-doughnut-ck">
                                                        ...
                                                        <canvas class="analytics-doughnut chartjs-render-monitor"
                                                            id="TrafficChannelDoughnutData" width="257" height="160"
                                                            style="display: block; width: 257px; height: 160px;"></canvas>
                                                    </div>
                                                    <div class="traffic-channel-group g-2">
                                                        <div class="traffic-channel-data">
                                                            <div class="title"><span class="dot dot-lg sq"
                                                                    data-bg="#9cabff"
                                                                    style="background: rgb(156, 171, 255);"></span><span>Organic
                                                                    Search</span></div>
                                                        ...
                                                        <div class="traffic-channel-data">
                                                            <div class="title"><span class="dot dot-lg sq"
                                                                    data-bg="#b8acff"
                                                                    style="background: rgb(184, 172, 255);"></span><span>Social
                                                                    Media</span></div>
                                                        ...
                                                        <div class="traffic-channel-data">
                                                            <div class="title"><span class="dot dot-lg sq"
                                                                    data-bg="#ffa9ce"
                                                                    style="background: rgb(255, 169, 206);"></span><span>Referrals</span>
                                                            </div>
                                                        ...
                                                        <div class="traffic-channel-data">
                                                            <div class="title"><span class="dot dot-lg sq"
                                                                    data-bg="#f9db7b"
                                                                    style="background: rgb(249, 219, 123);"></span><span>Others</span>
                                                            </div>
                                        ...
                                        <div class="card card-bordered h-100">
                                            ...
                                            <div class="nk-tb-list is-loose">
                                                <div class="nk-tb-item nk-tb-head">
                                                    ...
                                                    <div class="text-right nk-tb-col"><span>Users</span></div>
                                                    <div class="nk-tb-col"><span>% Users</span></div>
                                                    <div class="text-right nk-tb-col tb-col-sm"><span>Bounce Rate</span>
                                                    </div>
                                                </div><!-- .nk-tb-head -->
                                                <div class="nk-tb-item">
                                                    <div class="nk-tb-col">
                                                    ...
                                                    <div class="text-right nk-tb-col">
                                                        <span class="tb-sub tb-amount"><span>1,641</span></span>
                                                    </div>
                                                    <div class="nk-tb-col">
                                                        <div class="bg-transparent progress progress-md progress-alt">
                                                            <div class="progress-bar" data-progress="72.84"
                                                                style="width: 72.84%;"></div>
                                                            <div class="progress-amount">72.84%</div>
                                                        </div>
                                                    </div>
                                                    <div class="text-right nk-tb-col tb-col-sm">
